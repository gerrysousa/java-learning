package com.patterns.learn.creationalpatterns.builder.meal.after.director;

import com.patterns.learn.creationalpatterns.builder.meal.after.builder.FastFoodMealBuilder;
import com.patterns.learn.creationalpatterns.builder.meal.after.model.FastFoodMeal;
